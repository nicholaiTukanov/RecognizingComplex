...
// using MatmulOpLowering = BinaryOpLowering<toy::MatmulOp, linalg::MatmulOp >;  // lower MatmulOpLowering to MulFOp, need to be changed 
using MatmulOpLowering = BinaryOpLowering<toy::MatmulOp, arith::MulFOp >;  // lower MatmulOpLowering to MulFOp, need to be changed 
using ComplexMulKernelOpLowering = BinaryOpLowering<toy::ComplexMulKernelOp, arith::MulFOp>;
...
// struct MatmulOpLowering2 : public OpConversionPattern<toy::MatmulOp> {
//   using OpConversionPattern<toy::MatmulOp>::OpConversionPattern;

//   LogicalResult matchAndRewrite(
//       toy::MatmulOp op,  ArrayRef<Value> args,
//       ConversionPatternRewriter& rewriter) const final {
...
// struct MatmulOpLowering2 : public OpRewritePattern<toy::MatmulOp> {
...
//     rewriter.replaceOpWithNewOp<linalg::MatmulOp>(op);
//     return success();
//   }
// };
...
void ToyToAffineLoweringPass::runOnOperation() {
  ...
  target
      .addLegalDialect<AffineDialect, BuiltinDialect, arith::ArithmeticDialect,linalg::LinalgDialect,
  ...
  patterns.add<AddOpLowering, SubOpLowering, ConstantOpLowering, FuncOpLowering, MulOpLowering,MatmulOpLowering,ComplexMulKernelOpLowering,
